...
def test_esp32-event-driven-iot(dut: IdfDut, log_minimum_free_heap_size: Callable[..., None]) -> None:
...
def test_esp32-event-driven-iot_linux(dut: IdfDut) -> None:
    dut.expect('Hello world!')
...
@idf_parametrize('target', ['linux'], indirect=['target'])
def test_esp32-event-driven-iot_macos(dut: IdfDut) -> None:
    dut.expect('Hello world!')
...
def test_esp32-event-driven-iot_host(app: QemuApp, dut: QemuDut) -> None:
